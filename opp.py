...
if st.session_state.step == "init":
    ...
    if st.button("테스트 시작"):
        ...
        # 인사 및 단원 안내
        start_msg = f"안녕하세요 {st.session_state.user_name} 학생! {st.session_state.sel_sem} {st.session_state.sel_unit} 단원의 테스트를 시작할게요. 준비됐니?"
...
if prompt := st.chat_input("답변을 입력하세요"):
    ...
    2. 수식은 반드시 한글로 ('x의 제곱', '2분의 1', '루트 3') 말할 것
    3. 정답이면 크게 칭찬하고, 틀리면 힌트를 최대 2번 주어 스스로 답하게 유도할 것
